...
namespace BrightIdeasSoftware
{
    ...
    public class RearrangingDropSink : SimpleDropSink
    {
        ...
        public virtual void RearrangeModels(ModelDropEventArgs args) {
            ...
            if (args.SourceListView != this.ListView && !args.PreserveModels) {
    ...
    public class OlvDropEventArgs : EventArgs
    {
        ...
        /// <summary>
        /// Get or set if models from this event should be removed from source list. Ignored if Handled is true.
        /// </summary>
        public bool PreserveModels {
            get { return this.preserveModels; }
            set { this.preserveModels = value; }
        }
        private bool preserveModels;
