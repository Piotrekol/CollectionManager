...
namespace BrightIdeasSoftware {
    ...
    public partial class OLVColumn : ColumnHeader {
        ...
        /// <summary>
        /// Format that will be used when copying data to other text-based programs
        /// </summary>
        [Category("ObjectListView"),
         Description("Format that will be used when copying data to other text-based programs"),
         DefaultValue(null)]
        public string TextCopyFormat {
            get { return textCopyFormat; }
            set { textCopyFormat = value; }
        }
        private string textCopyFormat;
