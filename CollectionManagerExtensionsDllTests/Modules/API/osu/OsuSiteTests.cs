...
namespace CollectionManagerExtensionsDll.Modules.API.osu.Tests
{
    ...
    public class OsuSiteTests
    {
        ...
        {
            var obj = new OsuSite();
            var output = Run(() => obj.GetUsernames(1, 50, null));
        ...
        {
            var obj = new OsuSite();
            var output = Run(() => obj.GetUsernames(300, 800, null));
        ...
        {
            var obj = new OsuSite();
            var output = Run(() => obj.GetUsernames(1, 100, null));
        ...
        {
            var obj = new OsuSite();
            var output = Run(() => obj.GetUsernames(51, 51, null));
        ...
        {
            var obj = new OsuSite();
            var output = Run(() => obj.GetUsernames(1, 1, null));
            Assert.IsTrue(output.Count == 1);
        }
        [TestMethod()]
        ...
        {
            var obj = new OsuSite();
            var output = Run(() => obj.GetUsernames(1, 67, null));
