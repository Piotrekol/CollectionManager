...
namespace CollectionManagerExtensionsDll.Modules.API.osu.Tests
{
    ...
    public class OsuSiteTests
    {
        ...
        {
            var obj = new OsuSite();
            var output = obj.GetUsernames(1, 50);
        ...
        {
            var obj = new OsuSite();
            var output = obj.GetUsernames(1, 100);
        ...
        {
            var obj = new OsuSite();
            var output = obj.GetUsernames(51, 51);
        ...
        {
            var obj = new OsuSite();
            var output = obj.GetUsernames(1, 1);
            Assert.IsTrue(output.Count == 1);
        }
        [TestMethod()]
        ...
        {
            var obj = new OsuSite();
            var output = obj.GetUsernames(1, 67);
        ...
        {
            var obj = new OsuSite();
            var output = obj.GetUsernames(9951, 10001);
        }
    }
}