...
public class StartupPresenter : IDisposable
{
    ...
    public StartupPresenter(IStartupForm view, SidePanelActionsHandler sidePanelActionsHandler, IUserDialogs userDialogs, CollectionsManagerWithCounts collectionsManager, IInfoTextModel infoTextModel)
    {
        ...
        _startupSettings = JsonConvert.DeserializeObject<StartupSettings>(Initalizer.Settings.StartupSettings) ?? new StartupSettings();
    ...
    public async Task Run()
    {
        ...
        SetLoadingState(loadedCollectionFromFile || _startupSettings.AutoLoadMode);
    ...
    protected virtual void SetLoadingState(bool isLoading)
    {
        // TODO: add loading indicator per UI framework
    }
    ...
    {
        Initalizer.Settings.StartupSettings = JsonConvert.SerializeObject(_startupSettings);
