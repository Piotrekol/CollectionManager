...
public class CombinedListingPresenter
{
    ...
    public CombinedListingPresenter(ICombinedListingView view, ICollectionListingModel collectionListingModel, IBeatmapListingModel beatmapListingModel, IWebCollectionProvider webCollectionProvider, IUserDialogs userDialogs)
    {
        ...
        string[] visibleColumns = JsonConvert.DeserializeObject<string[]>(Initalizer.Settings.CollectionColumns);
    ...
    private void OnColumnsToggled(object sender, string[] visibleCollumnAspectNames) => Initalizer.Settings.CollectionColumns = JsonConvert.SerializeObject(visibleCollumnAspectNames);
