...
public class InfoTextModel : IInfoTextModel
{
    ...
    public IUpdateModel GetUpdater() => UpdateModel;

    public void EmitUpdateTextClicked() => UpdateTextClicked?.Invoke(this, EventArgs.Empty);

    public event EventHandler CountsUpdated;
    public event EventHandler UpdateTextClicked;

    protected virtual void OnCountsUpdated() => CountsUpdated?.Invoke(this, EventArgs.Empty);
